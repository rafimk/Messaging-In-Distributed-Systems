...
public class DeduplicationMessageHandlerDecorator<TMessage> : IMessageHandler<TMessage> where TMessage : class, IMessage
{
    private readonly IMessageHandler<TMessage> _handler;
    private readonly IMessageIdAccessor _messageIdAccessor;
    private readonly DbContext _dbContext;
    
    public DeduplicationMessageHandlerDecorator(IMessageHandler<TMessage> handler, 
